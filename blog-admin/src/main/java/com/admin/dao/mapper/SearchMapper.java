...
public interface SearchMapper {
    ...
    @Select("select my_article.id as id,title,createDate,updateDate,summary ,category_id from my_tag_article JOIN my_article ON my_article.id=my_tag_article.article_id where tag_id=#{tag_id} and category_id=#{category_id} and del_flag=0")
